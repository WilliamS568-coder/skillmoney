...
DROP POLICY IF EXISTS "Users can view their own daily income claims" ON daily_income_claims;
DROP POLICY IF EXISTS "Users can insert their own daily income claims" ON daily_income_claims;
DROP POLICY IF EXISTS "Users can update their own daily income claims" ON daily_income_claims;
